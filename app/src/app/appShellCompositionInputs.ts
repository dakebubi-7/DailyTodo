...
export function createAppShellCompositionInputs({
  ...
  return {
    ...
    mainContent: {
      ...
      currentDate: taskState.currentDate,
      ...
      setTodayFocus: taskState.setTodayFocus,
      setTodayFocusState: taskState.setTodayFocusState,
      adoptDailyReviewSuggestion: taskState.adoptDailyReviewSuggestion,
      ...
      todayFocusRequest: appState.todayFocusRequest,
