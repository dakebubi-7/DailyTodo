...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  chooseRestoreBackup: () => ipcRenderer.invoke('backup:chooseRestore'),
  restoreBackup: (request: unknown) => ipcRenderer.invoke('backup:restore', request),
  exportBackup: () => ipcRenderer.invoke('backup:export'),
  openBackupFolder: () => ipcRenderer.invoke('backup:openFolder'),
  openDiagnosticsFolder: () => ipcRenderer.invoke('support:openDiagnosticsFolder'),
  ...
  aiReview: {
    ...
    getDailyReviewBatch: (sourceDate: unknown) => ipcRenderer.invoke('aiReview:getDailyReviewBatch', sourceDate),
    runDailyReviewBatch: (sourceDate: unknown) => ipcRenderer.invoke('aiReview:runDailyReviewBatch', sourceDate),
